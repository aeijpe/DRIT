...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--n_ep', type=int, default=900, help='number of epochs') # 400 * d_iter
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--input_dim_a', type=int, default=1, help='# of input channels for domain A')
    self.parser.add_argument('--input_dim_b', type=int, default=1, help='# of input channels for domain B')
    self.parser.add_argument('--a2b', type=int, default=1, help='translation direction, 1 for CT2MRI or T12T2, 0 for MRItoCT or T22T1')
    ...
    self.parser.add_argument('--result_dir', type=str, default='../../../data/MMWHS/MRI_fake/', help='path for saving result images and models')
