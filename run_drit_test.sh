...
python evaluate_model.py --name small_mmwhs_run_fold_0 --data_type nnUNet --cases_fold 0 --data_dir1 $SCRATCH/data_dir1/Dataset_033_MMWHSCT/ --data_dir2 $SCRATCH/data_dir2/Dataset_034_MMWHSMRI/
